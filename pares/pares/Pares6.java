 ...
 * @author Bryam
 */
public class Pares6 extends javax.swing.JFrame {

    AudioClip audio, audio1, clic, inicio, acierto, agotado, perdio, victoria, paresC, superados;
    int gana6 = 0, termina = 0;
    int tiempo1 = 10, reg = 0;
    int a = 0, play = 0;
    ...
    public Pares6() {
        ...
        setTitle("CHILDREN'S GAME - PARES (NIVEL 6)");
    ...
    public void setCards() {
        ...
        btnC1.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[0] + ".png")));
        btnC2.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[1] + ".png")));
        btnC3.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[2] + ".png")));
        btnC4.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[3] + ".png")));
        btnC5.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[4] + ".png")));
        btnC6.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[5] + ".png")));
        btnC7.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[6] + ".png")));
        btnC8.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[7] + ".png")));
        btnC9.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[8] + ".png")));
        btnC10.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[9] + ".png")));
        btnC11.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[10] + ".png")));
        btnC12.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[11] + ".png")));
        btnC13.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[12] + ".png")));
        btnC14.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[13] + ".png")));
        btnC15.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[14] + ".png")));
        btnC16.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[15] + ".png")));
        btnC17.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[16] + ".png")));
        btnC18.setDisabledIcon(new ImageIcon(getClass().getResource("/pares/pares/imagenes5/c" + numbers[17] + ".png")));
    }
        ...
        if (x == tiempo1) {
            ...
            if (gana6 == 0) {
                ...
                JOptionPane.showMessageDialog(null, "¡ Tu Tiempo Termino !\n ¡ Nivel No Superado !", "Pares",
                        0, new javax.swing.ImageIcon(getClass().getResource("/pares/pares/pick/rosaR.png")));
    ...
    public void reiniciar() {
        ...
        JOptionPane.showMessageDialog(null, "                  (Nivel 6)\nEcuentra todos los pares antes de\nque el"
                + " cronometro llegue a 00:10:00.", "Pares", 0, new javax.swing.ImageIcon(getClass().getResource("/pares/pares/pick/rosaR.png")));
        inicio = java.applet.Applet.newAudioClip(getClass().getResource("/pares/tonos/2.mp3"));
        inicio.play();
        t.start();
    ...
    public void pregwin() {
        if (!btnC1.isEnabled() && !btnC2.isEnabled() && !btnC3.isEnabled() && !btnC4.isEnabled() && !btnC5.isEnabled() && !btnC6.isEnabled()
            ...
            if (gana6 == 0) {
                ...
                ip.llenarMenu6();
                ip.setVisible(true);
                superados = java.applet.Applet.newAudioClip(getClass().getResource("/pares/tonos/superadosT.wav"));
                superados.play();
                JOptionPane.showMessageDialog(null, "       ¡ MUCHAS FELICIDADES !\n¡ Has superado todos los niveles !\n                 1, 2, 3, 4, 5, 6", "Pares",
                        0, new javax.swing.ImageIcon(getClass().getResource("/pares/pares/pick/desbSM.png")));
                superados.stop();
                inicio = java.applet.Applet.newAudioClip(getClass().getResource("/pares/tonos/2.mp3"));
                inicio.play();
            }
    ...
    private void initComponents() {
        ...
        btnC1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC2.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC3.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC4.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC16.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC15.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC8.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC7.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC6.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC5.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC10.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC12.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC14.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC13.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC11.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC9.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC17.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        btnC18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f00.png"))); // NOI18N
        ...
        btnC18.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/imagenes5/f0.png"))); // NOI18N
        ...
        panel2.setColorSecundario(new java.awt.Color(255, 204, 255));

        labelMetric1.setText("¡¡¡ Encuentra Todos Los Pares !!!");
        labelMetric1.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N

        etiquetaTiempo.setBackground(new java.awt.Color(255, 204, 204));
        ...
        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pares/pares/ini6.png"))); // NOI18N
...
public Timer t;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pares6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
