...
//    private String juego2 = "juego2";
    ...
    private int[] win = {-1, 2, 3, 4, 5, 6, 7, 8, 9}; // -1 = casilla vacia
     ...
     * 6 | 7 | 8
     */
    private bPieza1 matriz[] = new bPieza1[fila * columna];

//carga imagenes de nuevo juego
    public void NewGame(bPieza1 m[]) {
        this.matriz = m;
...
//Finaliza el juego :)
    public void Terminar() {
        for (int i = 0; i < win.length; i++) {
            matriz[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/logo/logoNG.png")));
...
//Llena la matriz de controles con imagenes dado un array numerico con las posiciones de las mismas ¿se entendio?
    void llenar_tablero(int[] m, boolean band) {
        for (int i = 0; i < win.length; i++) {
            if (m[i] > -1) {
                matriz[i].setIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego1 + "/" + m[i] + ".png")));
                matriz[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego1 + "/" + m[i] + ".png")));
            } else if (band) {
                matriz[i].setIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego1 + "/" + (i + 1) + ".png")));
                matriz[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego1 + "/" + (i + 1) + ".png")));
            } else {
                matriz[i].setIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/logo/logoBG.png")));
                matriz[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/logo/logoBG.png")));
            }
        }
    }
