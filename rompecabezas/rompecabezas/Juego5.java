 ...
 * @author Bryam
 */
public class Juego5 implements ActionListener {

    AudioClip mov, victoria;
    int a = 0, b = 0;
    boolean termina = false;
    private String juego5 = "juego5";
//    private String juego2 = "juego2";
    ...
    private int[] win = {1, 2, 3, 4, 5, 6, -1, 8, 9, 10,
        11, 12, 13, 14, 15, 16}; // -1 = casilla vacia
     ...
     * 6 | 7 | 8
     */
    private bPieza5 matriz5[] = new bPieza5[fila * columna];

//carga imagenes de nuevo juego
    public void NewGame(bPieza5 m[]) {
        this.matriz5 = m;
...
//Finaliza el juego :)
    public void Terminar() {
        for (int i = 0; i < win.length; i++) {
            matriz5[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/logo/logoN.png")));
...
//Llena la matriz de controles con imagenes dado un array numerico con las posiciones de las mismas ¿se entendio?
    void llenar_tablero(int[] m, boolean band) {
        for (int i = 0; i < win.length; i++) {
            if (m[i] > -1) {
                matriz5[i].setIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego5 + "/" + m[i] + ".png")));
                matriz5[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego5 + "/" + m[i] + ".png")));
            } else if (band) {
                matriz5[i].setIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego5 + "/" + (i + 1) + ".png")));
                matriz5[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/puzzle/" + juego5 + "/" + (i + 1) + ".png")));
            } else {
                matriz5[i].setIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/logo/logoB.png")));
                matriz5[i].setDisabledIcon(new ImageIcon(getClass().getResource("/rompecabezas/rompecabezas/logo/logoB.png")));
            }
        }
    }
